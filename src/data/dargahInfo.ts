import { DargahInfo } from '../types';

export const dargahInfo: DargahInfo = {
  id: '1',
  name: 'Dargah & Khanqah Mehfil-e-Hasani',
...
export const aboutDargah = [
  ...
  },
  {
    ...
    content: 'Hazrat Syed Mansoor-ul-Hasan Shah (R.A.) was a renowned Sufi master of the Qadri, Chishti, Sabri, Abululai, Jahangiri, and Hasani traditions. A descendant of Sheikh Abdul Qadir Jilani (R.A.) and connected to the noble Ahl-ul-Bayt, his life embodied sincerity, devotion, and service. Having trained under Hazrat Khwaja Hasan Sarkar of Bhensori Sharif, he carried the spiritual heritage of the Hasni Silsila to Maharashtra and beyond.'
  },
  {
    title: 'Present Sajjada Nashin',
    content: 'The spiritual leadership of the Khanqah rests with Hazrat Sufi Syed Waseem-ur-Rehman Shah (Jugnu Miya), the beloved grandson and successor of Hazrat Mansoor-ul-Hasan Shah (R.A.). As the Sajjada Nashin, he guides seekers through weekly Zikr gatherings, Majalis, youth engagement initiatives, and community outreach.'
  },
  {
